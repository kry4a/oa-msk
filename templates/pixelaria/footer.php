      ...
      <div class="container">
        <div class="footer__links">
          <div class="footer__info info">
            <div itemprop="name" class="info__title" style="margin-bottom: 33px;">Оптимальные<br/>алгоритмы</div>
            <div itemscope="" itemtype="http://schema.org/Organization" class="info__text">
          ...
          <div class="links">
            ...
            <ul class="links__list list">
              <li class="list__item"><a href="/new/development/" class="list__link">Доработка 1С на заказ</a></li>
        ...
        <div class="footer__copyright copyright">
          <span class="copyright__link">(С) 2011-2017 Оптимальные алгоритмы</span>
          <span class="copyright__text">+7 (495) 268-07-49 Копирование материалов только с разрешения владельца</span>
          <div class="develop">Разработано в <a href="http://pixelaria.ru" targer="_blank" class="link link--green link--bold">Pixelaria</a></div>
        </div>
      </div>
    </footer>
  </body>
